        ...
        protected override void OnPaintSurface(SKPaintSurfaceEventArgs e)
        {
            ...
            if (StartColor != Color.Default && EndColor != Color.Default)
            {
                barColorPaint.Shader = SKShader.CreateLinearGradient(
                               ...
                               new SKColor[] { EndColor.ToSKColor(), SKColors.Orange, SKColors.Green, StartColor.ToSKColor() },
                               null,
                               SKShaderTileMode.Repeat);
            }
            canvas.DrawRoundRect(0, PGHeight - (PGHeight * Progress / 100), PGWidth, PGHeight, PGWidth / 2, 0, barColorPaint);
